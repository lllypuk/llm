...
- `cmd/llmcheck`: ответ сверяется словом целиком, без регистра и обрамляющей пунктуации, а не
  подстрокой — «not red» и «некрасный» больше не проходят проверку кадра.
